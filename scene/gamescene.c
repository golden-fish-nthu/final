...
Scene *New_GameScene(int label)
{
    ...
    pDerivedObj->countdownTime = 12.0; // 设置倒计时时长为120秒
...
void game_scene_draw(Scene *self)
{
    ...
    al_draw_text(gs->font, al_map_rgb(255, 255, 255), screenWidth - textWidth - 10, 10, 0, scoreText); // 10 pixels padding from the right edge
}
