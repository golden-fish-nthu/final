...
void Introduction_draw(Scene *self)
{
    ...
    al_draw_text(Obj->font, al_map_rgb(255, 0, 255), WIDTH / 2, HEIGHT / 2-140, ALLEGRO_ALIGN_CENTRE, "遊戲簡介");
    al_draw_text(Obj->font, al_map_rgb(255, 0, 255), WIDTH / 2, HEIGHT / 2-100, ALLEGRO_ALIGN_CENTRE, "今天媽媽不再加家裡沒人做飯你必須擔起這個重任");
    al_draw_text(Obj->font, al_map_rgb(255, 0, 255), WIDTH / 2, HEIGHT / 2-60, ALLEGRO_ALIGN_CENTRE, "遊戲規則");
    al_draw_text(Obj->font, al_map_rgb(255, 0, 255), WIDTH / 2, HEIGHT / 2-20, ALLEGRO_ALIGN_CENTRE, "時間結束之錢拿到盡量高的分數");
    al_draw_text(Obj->font, al_map_rgb(255, 0, 255), WIDTH / 2, HEIGHT / 2 + 20, ALLEGRO_ALIGN_CENTRE, "WASD移動角色");
    al_draw_text(Obj->font, al_map_rgb(255, 0, 255), WIDTH / 2, HEIGHT / 2 + 60, ALLEGRO_ALIGN_CENTRE, "W(上)S(下)A(左)D(右)");
    al_draw_text(Obj->font, al_map_rgb(255, 0, 255), WIDTH / 2, HEIGHT / 2 + 100, ALLEGRO_ALIGN_CENTRE, "ESC返回上一頁");
}
